...
import { AmiBuildPage } from './pages/AmiBuildPage'
import './App.css'

type Page = 'workstations' | 'costs' | 'reaper' | 'command' | 'ami'
  ...
  return (
    <div className="app">
      <nav className="app-nav">
        ...
        <button
          type="button"
          className={`app-nav-tab${page === 'ami' ? ' app-nav-tab--active' : ''}`}
          onClick={() => setPage('ami')}
        >
          AMI build
        </button>
